  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/80 backdrop-blur-md">
      <nav className="mx-auto flex max-w-2xl items-center justify-between px-6 py-3">
        <Link
          href="/"
          className="font-mono text-sm font-medium text-foreground no-underline transition-colors hover:text-accent"
        >
          {"<ethrmor />"}
        </Link>
        <div className="flex items-center gap-1">
          ...
          <div className="ml-2 flex items-center gap-1 border-l border-border pl-2">
            <a
              href="https://twitter.com/ethrmor"
              target="_blank"
